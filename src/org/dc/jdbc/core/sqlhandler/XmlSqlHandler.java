...
public class XmlSqlHandler extends SQLHandler{
	...
	public SqlEntity handleRequest(String sqlOrID,Object[] params) throws Exception{
		...
		int question_Seq_index = sqlSource.indexOf("?");
		if(question_Seq_index > -1){//问号匹配符
			...
			int quote_Seq_index = -1;
			while((quote_Seq_index = sqlSource.indexOf("#"))>-1){
				int indexEnd = sqlSource.indexOf("}");
